...
`, "",{"version":3,"sources":["webpack://./stories/searchProduct.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,YAAY;EACZ,oCAAoC;EACpC,2CAA2C;AAC7C;AACA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;EACnB,kBAAkB;EAClB,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,aAAa;AACf;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,aAAa;EACb,eAAe;EACf,kBAAkB;AACpB;AACA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,yBAAyB;EACzB,kBAAkB;EAClB,OAAO;EACP,SAAS;EACT,gBAAgB;EAChB,gBAAgB;EAChB,qBAAqB;AACvB;;AAEA;EACE,qBAAqB;EACrB,eAAe;AACjB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,eAAe;AACjB;;AAEA;;;;;;;;;;GAUG;;AAEH;EACE,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,UAAU;EACV,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,mBAAmB;AACrB","sourcesContent":[".search-product {\n  width: fit-content;\n  height: auto;\n  background-color: rgb(156, 105, 105);\n  box-shadow: rgba(0, 0, 0, 0.18) 0px 2px 4px;\n}\n.search {\n  display: flex;\n  /* justify-content: center; */\n  align-items: center;\n  width: fit-content;\n  height: auto;\n  padding: 14px 24px;\n}\n\n.search input {\n  border-radius: 5px;\n  padding: 10px;\n}\n\n.search i {\n  color: #fff;\n  border-radius: 5px;\n  padding: 10px;\n  cursor: pointer;\n  position: relative;\n}\n.filter-popup {\n  width: fit-content;\n  /* height: 25vh; */\n  background-color: #888686;\n  position: absolute;\n  top: 7%;\n  left: 27%;\n  overflow: hidden;\n  overflow-y: auto;\n  list-style-type: none;\n}\n\n.filter-popup li {\n  text-decoration: none;\n  cursor: pointer;\n}\n\n.filter-popup li :hover {\n  background-color: #b45555;\n}\n\n.filter-popup li span {\n  font-size: 12px;\n}\n\n/* .filter-popup {\n  width: fit-content;\n  height: 20vh;\n  background-color: #888686;\n  position: absolute;\n  top: 0;\n  right: 0;\n  overflow: hidden;\n  overflow-y: auto;\n  list-style-type: none;\n} */\n\n.list {\n  width: fit-content;\n  height: auto;\n}\n\n.product-list {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  border-radius: 5px;\n}\n\n.product-list li {\n  padding: 10px;\n  cursor: pointer;\n}\n\n.product-list li:last-child {\n  border-bottom: none;\n}\n"],"sourceRoot":""}]);
// Exports
...
const createSearchProduct = () => {
  ...
  const brands = [...new Set(products.map((products) => products.brand))];
  ...
  filterIcon.appendChild(filterPopup);
...
//# sourceMappingURL=SearchProduct-stories.e7e75fe7eda987048b8a.hot-update.js.map