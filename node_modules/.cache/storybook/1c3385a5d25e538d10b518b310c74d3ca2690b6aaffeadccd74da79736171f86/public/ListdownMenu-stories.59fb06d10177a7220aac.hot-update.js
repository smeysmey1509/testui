...
const createListdownMenu = ({ title, items = [] } = {}) => {
  ...
  items.forEach((item) => {
    ...
    if (item.children && item.children.length > 0) {
      ...
      childUl.style.listStyleType = '"- "'; // Optional: Customize the list style for child items
...
//# sourceMappingURL=ListdownMenu-stories.59fb06d10177a7220aac.hot-update.js.map