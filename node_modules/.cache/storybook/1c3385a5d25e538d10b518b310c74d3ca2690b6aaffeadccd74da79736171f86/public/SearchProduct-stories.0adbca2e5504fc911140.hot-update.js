...
const Default = {
  ...
  play: async ({
    ...
    _storybook_testing_library__WEBPACK_IMPORTED_MODULE_1__.userEvent.type(searchInput, "Ford");

    // Check if filtered products are displayed
    await new Promise(resolve => setTimeout(resolve, 1000)); // Wait for filtering to apply
    ...
    if (filterIcon) {
      ...
      await canvas.findByText("Tesla");

      // Check if the filter popup contains brand options
      expect(canvas.getByText("Tesla")).toBeInTheDocument();

      // Click on the "Tesla" brand to filter
      _storybook_testing_library__WEBPACK_IMPORTED_MODULE_1__.userEvent.click(canvas.getByText("Tesla"));
      ...
      // Clear filter
      _storybook_testing_library__WEBPACK_IMPORTED_MODULE_1__.userEvent.click(canvas.getByText("Clear Filter"));
...
//# sourceMappingURL=SearchProduct-stories.0adbca2e5504fc911140.hot-update.js.map