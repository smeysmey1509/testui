...
const createListdownMenu = ({ title } = {}) => {
  ...
  const listdownUi = document.createElement("ul");
  ...
  items.forEach((item) => {
    ...
    // Optionally, style each list item
    ...
    listdownUi.appendChild(listItem);
  });

  listdownMenu.appendChild(listdownTitle);
  listdownMenu.appendChild(listdownUi);
...
//# sourceMappingURL=ListdownMenu-stories.b696c5e3c505386de81d.hot-update.js.map