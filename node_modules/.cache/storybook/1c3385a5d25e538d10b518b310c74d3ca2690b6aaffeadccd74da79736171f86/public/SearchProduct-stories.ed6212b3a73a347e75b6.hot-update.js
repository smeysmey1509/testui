...
const createSearchProduct = () => {
  const products = [
    ...
    { name: "Ford Explorer", brand: "Ford" },
    { name: "Audi Q3", brand: "Audi" },
  ];
  ...
  brands.forEach((brand) => {
    ...
    brandTitle.textContent = item.brand;
...
//# sourceMappingURL=SearchProduct-stories.ed6212b3a73a347e75b6.hot-update.js.map