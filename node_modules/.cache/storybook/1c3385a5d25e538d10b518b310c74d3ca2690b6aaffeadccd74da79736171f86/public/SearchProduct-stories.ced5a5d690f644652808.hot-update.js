...
const Default = {
  ...
  play: async ({
    ...
    if (filterIcon) {
      ...
      await canvas.findByText("Ford");

      // Check if the filter popup contains brand options
      expect(canvas.getByText("Ford")).toBeInTheDocument();

      // Click on the "Tesla" brand to filter
      _storybook_testing_library__WEBPACK_IMPORTED_MODULE_1__.userEvent.click(canvas.getByText("Ford"));
...
//# sourceMappingURL=SearchProduct-stories.ced5a5d690f644652808.hot-update.js.map