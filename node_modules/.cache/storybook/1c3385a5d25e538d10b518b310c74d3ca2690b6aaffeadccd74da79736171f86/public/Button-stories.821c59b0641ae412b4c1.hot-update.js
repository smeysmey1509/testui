...
Primary.play = async ({
  ...
  aw; // Verify the button text is correctait expect(primaryButton).toHaveTextContent("Button");

  await (0,_storybook_testing_library__WEBPACK_IMPORTED_MODULE_2__.expect)(primaryButton).toHaveTextContent("Button");
};
const Secondary = {
  args: {
    label: "Button"
...
//# sourceMappingURL=Button-stories.821c59b0641ae412b4c1.hot-update.js.map