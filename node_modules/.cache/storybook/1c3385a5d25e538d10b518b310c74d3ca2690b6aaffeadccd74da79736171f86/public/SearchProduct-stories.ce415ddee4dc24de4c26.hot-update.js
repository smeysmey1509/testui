...
/* harmony import */ var _jest_globals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @jest/globals */ "./node_modules/@jest/globals/build/index.js");
/* harmony import */ var _jest_globals__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_jest_globals__WEBPACK_IMPORTED_MODULE_2__);
...
const Default = {
  ...
  play: async ({
    ...
    if (filterIcon) {
      ...
      (0,_jest_globals__WEBPACK_IMPORTED_MODULE_2__.expect)(teslaBrand).toBeInTheDocument();
      ...
      (0,_jest_globals__WEBPACK_IMPORTED_MODULE_2__.expect)(teslaModelS).toBeInTheDocument();
      (0,_jest_globals__WEBPACK_IMPORTED_MODULE_2__.expect)(canvas.queryByText("Ford Mustang")).not.toBeInTheDocument();

      // Clear filter
      _storybook_testing_library__WEBPACK_IMPORTED_MODULE_1__.userEvent.click(await canvas.findByText("Clear Filter"));

      // Wait for all products to be displayed again
      const fordMustang = await canvas.findByText("Ford Mustang");
      (0,_jest_globals__WEBPACK_IMPORTED_MODULE_2__.expect)(fordMustang).toBeInTheDocument();
    } else {
...
//# sourceMappingURL=SearchProduct-stories.ce415ddee4dc24de4c26.hot-update.js.map