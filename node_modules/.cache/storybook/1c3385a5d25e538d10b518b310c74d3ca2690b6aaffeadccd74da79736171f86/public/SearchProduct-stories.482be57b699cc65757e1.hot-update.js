...
const createSearchProduct = ({
  ...
  const products = [
    ...
    { name: "Focus", brand: "Ford" },
    { name: "Equinox", brand: "Chevrolet" },
    { name: "Z4", brand: "BMW" },
    { name: "A6", brand: "Audi" },
    { name: "Roadster", brand: "Tesla" },
  ];
...
//# sourceMappingURL=SearchProduct-stories.482be57b699cc65757e1.hot-update.js.map