...
const createSearchProduct = () => {
  ...
  popup.textContent = "Hello World"; // Example text
  popup.style.display = "none"; // Initially hidden

  // Toggle popup visibility when the icon is clicked
  ...
  document.addEventListener("click", (event) => {
    if (!filterIcon.contains(event.target) && !popup.contains(event.target)) {
...
//# sourceMappingURL=SearchProduct-stories.12e91026fe5e3416aa85.hot-update.js.map